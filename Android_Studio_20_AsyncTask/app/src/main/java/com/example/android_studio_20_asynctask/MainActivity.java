package com.example.android_studio_20_asynctask;
...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.imagelist1);
    ...
    public void onClick(View v) {
        new downloadimg().execute("https://images.pexels.com/photos/5309143/pexels-photo-5309143.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940");
    }
